...
export default function SignInPage() {
  ...
  return (
    <main className="relative isolate flex min-h-screen items-center justify-center px-6 py-16">
      ...
      <div className="pointer-events-none absolute left-1/2 top-12 -z-10 h-72 w-72 -translate-x-1/2 rounded-full bg-cyan-500/15 blur-3xl" />
      <div className="pointer-events-none absolute bottom-20 right-10 -z-10 hidden h-48 w-48 rounded-full bg-purple-500/10 blur-3xl sm:block" />
      ...
      <div className="w-full max-w-lg space-y-10 rounded-3xl border border-white/10 bg-white/5 p-10 shadow-inner shadow-black/30 backdrop-blur">
        <header className="space-y-3 text-center">
          ...
          <p className="text-sm text-slate-300">
            We send a one-time magic link to sign you in. It works on desktop and
            mobile.
          </p>
        </header>
