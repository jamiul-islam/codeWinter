        ...
        <div style={{ width: '240px' }}>
          ...
          <div style={{ fontSize: '11px', color: 'rgba(147, 163, 179, 0.8)', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>Status</span>
              <span style={{ color: '#34D399', fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>Ready</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>Dependencies</span>
              <span style={{ fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>0</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>PRD</span>
              <span style={{ color: '#34D399', fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>Generated</span>
            </div>
          </div>
        </div>
      )
      ...
      label: (
        <div style={{ width: '240px' }}>
          ...
          <div style={{ fontSize: '11px', color: 'rgba(147, 163, 179, 0.8)', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>Dependencies</span>
              <span style={{ fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>1</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>PRD</span>
              <span style={{ color: '#34D399', fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>Generated</span>
      ...
      label: (
        <div style={{ width: '240px' }}>
          ...
          <div style={{ fontSize: '11px', color: 'rgba(147, 163, 179, 0.8)', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>Status</span>
              <span style={{ color: '#F59E0B', fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>In Progress</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>Dependencies</span>
              <span style={{ fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>2</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>PRD</span>
              <span style={{ color: '#6EE7F9', fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>Generating</span>
            </div>
          </div>
        </div>
      )
      ...
      label: (
        <div style={{ width: '240px' }}>
          ...
          <div style={{ fontSize: '11px', color: 'rgba(147, 163, 179, 0.8)', lineHeight: '1.6', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>Dependencies</span>
              <span style={{ fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>3</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '8px' }}>
              <span style={{ whiteSpace: 'nowrap', flexShrink: 0 }}>PRD</span>
              <span style={{ color: '#34D399', fontWeight: '500', whiteSpace: 'nowrap', textAlign: 'right' }}>Generated</span>
...
export function HeroGraph() {
  ...
  return (
    <div className="w-full h-[550px] rounded-2xl border border-primary/20 bg-surface/50 backdrop-blur overflow-hidden">
      <ReactFlow
        nodes={nodes}
        edges={edges}
